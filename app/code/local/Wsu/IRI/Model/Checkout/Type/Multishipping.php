...
class Wsu_IRI_Model_Checkout_Type_Multishipping extends Mage_Checkout_Model_Type_Multishipping {
    public function setIrisimplementMethod($payment) {
        if (!isset($payment['method'])) {
            Mage::throwException(Mage::helper('checkout')->__('Irisimplement method is not defined'));
        }
        $quote           = $this->getQuote();
        ...
        $quote->getIrisimplement()->importData($payment);
